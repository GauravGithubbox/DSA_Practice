...
public class CircularQueue {
    ...
    CircularQueue(int n) {
        ...
        front = -1; // In circular practice.queue we also initialize front = -1
    }
    ...
    public boolean isFull() {
        return (rear + 1) % size == front; // When we are trying to put the element in the practice.stack at the next index front is present that means
        // out practice.queue is full
    }
