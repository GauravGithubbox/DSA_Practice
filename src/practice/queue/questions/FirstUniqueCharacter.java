...
public class FirstUniqueCharacter {
    ...
    public static int firstUniqChar(String A) {
        ...
        // First pass: count the frequency of each character and add their indices to the practice.queue
        ...
        // Second pass: find the first non-repeating character by checking the practice.queue
        while (!q.isEmpty()) {
            int index = q.poll(); // Retrieve and remove the head of the practice.queue
