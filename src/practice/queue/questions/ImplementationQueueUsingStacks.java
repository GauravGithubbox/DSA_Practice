...
public class ImplementationQueueUsingStacks {
    ...
    // Push element x to the back of the practice.queue.
    ...
    // Removes the element from the front of the practice.queue and returns it.
    public int pop() {
        return stack1.pop();
    }
    ...
    // Returns whether the practice.queue is empty.
