/*Given a sorted practice.array of distinct integers and a target value, return the index if the target is found. If not, return the index where it would be if it were inserted in order.
...
public class SearchInsertPosition {
    ...
    // Method to find the insert position of target in a sorted practice.array
