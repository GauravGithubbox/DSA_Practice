/*Given a sorted practice.array arr[] of size N without duplicates, and given a value x. Floor of x is defined as the largest element K in arr[] such that K is smaller than or equal to x. Find the index of K(0-based indexing).
...
class FloorSearch {
    ...
    public static void main(String[] args) {
        ...
        if (result != -1) {
            ...
            System.out.println("No floor found for " + x + " in the practice.array.");
        }
    }
}
