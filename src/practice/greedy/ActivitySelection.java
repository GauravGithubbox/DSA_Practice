...
public class ActivitySelection {
    public static void main(String[] args) { // T.C. nlog(n)
        ...
        int end[] = {2,4,6,7,9,9};
        // suppose if the 2nd practice.array is not sorted
        // how we can sort this practice.array
        int activities[][] = new int[start.length][3]; // why 3 because we need to create 3 columns index , startTime , endTime that's why nX3 practice.array
        ...
        maxAct =1;
        ans.add(activities[0][0]); // why we are adding first index because practice.array is sorted according to end date
