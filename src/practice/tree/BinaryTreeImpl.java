...
public class BinaryTreeImpl {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("practice.tree root =>" + root.data);
        tree.preOrder(root);
        tree.inOrder(root);
        tree.postOrder(root);
        ...
        System.out.println("count practice.tree nodes =>" + count);
        int sum = tree.sum(root);
        System.out.println("sum of practice.tree nodes =>" + sum);
    }
}
